...
{   
    ...
    public class OdfxDevice
    {
        ...
        private void OdfxCreateVolumeDevice(byte[] VolumeInfo)
        {
            ...
            this.PageShift = (byte)(0x1F - Modex360.Library.Systems.FATX.FatxDevice.CountLeadingZerosWord(PageSize));
        ...
        private OdfxGdfDirectoryEntry OdfxGdfLookupElementNameInDirectory(OdfxFcb ParentFcb, string FileName)
        {
            ...
            do
            {
                ...
                {
                    buffer = this.FscMapBuffer(Modex360.Functions.Global.ROTL64(ParentFcb.FirstBlockNumber, 11) + (blockMod = (int)(blockIdx & 0xFFFFF800)), 0x1000);
                ...
                blockIdx = Modex360.Functions.Global.ROTL32(nextEntryOffset, 2);
        ...
        private byte[] FscMapBuffer(long PhysicalOffset, long DataSize)
        {
            ...
            if (VolumeType == OdfxType.SVOD)
            {
                ...
                PhysicalOffset = Modex360.Functions.Global.ROTL64((PhysicalOffset >> 0x0C) & 0xFFFFFFFF, 0x0C) & 0xFFFFFFFF000;
