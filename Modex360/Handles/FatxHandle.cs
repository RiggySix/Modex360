...
namespace Modex360
{
    ...
    {
        private static Modex360.Forms.Main Main;
        ...
        {
            Main = Modex360.Forms.Main.mainForm;
        ...
        {
            if (UI.messageBox("Changes may not take effect until you restart Modex360.\n\nYour devices will take a bit longer to load the next few times while Modex360 rebuilds the cache.\n\nAre you sure you want to clear your title name cache?",
