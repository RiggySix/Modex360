...
namespace Ubisoft
{
    internal class ACIIISaveGame
    {
        ...
        public ACIIISaveGame(EndianIO io)
        {
            IO = io;
        ...
        private void Read()
        {
            ...
            // read main segment
            if ((AssassinsCreedGameVerison)IO.In.ReadInt32() != AssassinsCreedGameVerison.III || IO.In.ReadInt32() != 0x00FEDBAC || IO.In.ReadInt64() != 0x00)
            ...
            //fileio.Stream.Save(@"F:\Projects\Assassin's Creed\III\Saves\3\ASSASSINSCREED3SAVEGAME");
        ...
        public void Save()
        {
            ...
            io.Out.Write((int)AssassinsCreedGameVerison.III, EndianType.BigEndian);
