...
namespace YuGiOhMilleniumDuels
{
    internal class CardListEntry
    {
        ...
        {
            var bitmask = Modex360.Functions.BitHelper.ProduceBitmask(mask);
        ...
        public byte ToArray()
        {
            ...
            mask[7] = New;
            byte card = Modex360.Functions.BitHelper.ConvertToWriteableByte(mask);// should not be more than 8 bits
