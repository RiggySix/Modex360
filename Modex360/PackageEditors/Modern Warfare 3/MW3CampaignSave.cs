...
using Modex360.Controls;
using CallofDuty;

namespace Modex360.PackageEditors.Modern_Warfare_3
{
    public partial class MW3CampaignSave : EditorControl
    {
        //public static readonly string FID = "415608CB";
        ...
        public MW3CampaignSave()
        {
            InitializeComponent();
            TitleID = FormID.MW3CampaignSave;
            

            this.modPanels = new RibbonPanel[]
            {
                panelMain
            };
