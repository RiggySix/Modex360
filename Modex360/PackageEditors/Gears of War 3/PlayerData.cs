...
namespace Modex360.PackageEditors.Gears_of_War_3
{
    public partial class PlayerData : EditorControl
    {
        ...
        private static readonly Dictionary<string, string> Weapons;
        ...
        private static readonly Dictionary<EntryID, string> RibbonDescriptions;
        internal static readonly List<MedalData> Medals;
        ...
        public override bool Entry()
        {
            ...
            Modex360.ProfileData profileData = ProfileManager.fetchRealProfile(Package.Header.Metadata.Creator);
            if (profileData == null)
            {
