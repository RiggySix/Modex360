...
namespace Ubisoft
{
    internal class ACRogueSaveGame
    {
        ...
        internal ACRogueSaveGame(EndianIO io)
        {
            IO = io;
            Read();
        }
        ...
        private void Read()
        {
            ...
            // read main segment
            if ((AssassinsCreedGameVerison)IO.In.ReadInt32() != AssassinsCreedGameVerison.Rogue || IO.In.ReadInt32() != 0x00FEDBAC || IO.In.ReadInt64() != 0x00)
