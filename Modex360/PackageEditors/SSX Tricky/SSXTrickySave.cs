...
namespace SSX
{
    public class SSXGameSave
    {
        ...
        private void ReadMainPlayerDb(int Length)
        {
            ...
            byte[] test2 = io.In.ReadBytes(Modex360.Functions.Global.ROTL32(test1[0x18], 0x4));
        ...
        private void WriteMainPlayerDb()
        {
            ...
            byte[] test2 = SaveIO.In.ReadBytes(Modex360.Functions.Global.ROTL32(test1[0x18], 0x4));
