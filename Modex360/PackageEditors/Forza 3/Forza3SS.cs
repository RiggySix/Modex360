    ...
    public partial class Forza3SS : EditorControl
    {
        ...
        private void ExtractBtnCallback(object sender, EventArgs e)
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                ...
                Modex360.Functions.UI.messageBox("Successfully extracted a screenshot!", "Done!", MessageBoxIcon.Information);
            }
        }
        ...
        private void Inject(string Filename)
        {
            ...
            Modex360.Functions.UI.messageBox("Successfully injected screenshot!", "Done!", MessageBoxIcon.Information);
        }
