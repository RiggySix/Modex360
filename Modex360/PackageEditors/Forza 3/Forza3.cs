...
namespace Modex360.PackageEditors.Forza_3
{
    public partial class Forza3 : EditorControl
    {
        ...
        private void ReadPlayerDatabase()
        {
            ...
            PlayerDatabase = new PlayerDatabase(new MemoryStream(this.PlayerDatabaseIO.ToArray()), Modex360.Functions.Global.hexStringToArray(this.Package.Header.Metadata.Creator.ToString("X")));
