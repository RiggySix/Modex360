...
namespace Modex360.PackageEditors.Forza_4
{
    public partial class Forza4Livery : EditorControl
    {
        ...
        private void CombBox_LiveryTypeChanged(object sender, EventArgs e)
        {
            ...
            {
                Modex360.Functions.UI.messageBox("Failed to load any liveries. Try a different type.");
            }
        }
        ...
        private void BtnClick_ExtractLivery(object sender, EventArgs e)
        {
            ...
            {
                Modex360.Functions.UI.messageBox("Please select a file and its Livery-type before attempting to extract a file.");
            }
            else
            {
                byte[] SaveData = null;
        ...
        private void BtnClick_UnlockAll(object sender, EventArgs e)
        {
            ...
            {
                Modex360.Functions.UI.messageBox("Could not read livery database.");
            }
        }
                    ...
                    if (index != -1)
                    {
                        ...
                        switch (LoadedLiveryType)
                        {
                            case ForzaMotorsport.ForzaFileTypes.CarSetups:
                                ...
                                {
                                    Modex360.Functions.UI.messageBox("Error: Selected file is not a valid tune setup. Try to select a different type.");
                                }
                                break;
                            case ForzaMotorsport.ForzaFileTypes.Vinyls:
                                try
                                ...
                                {
                                    Modex360.Functions.UI.messageBox("Error: Selected file is not a valid vinyl design. Try to select a different type.");
                                }
                                break;
                            case ForzaMotorsport.ForzaFileTypes.Liveries:
                                try
                                ...
                                {
                                    Modex360.Functions.UI.messageBox("Error: Selected file is not a valid livery design. Try to select a different type.");
                                }
                                break;
                            default:
                                Modex360.Functions.UI.messageBox("Please selecte a livery file type.");
                                break;
                        }
