...
namespace Modex360.PackageEditors.Forza_4
{
    public partial class Forza4Profile : EditorControl
    {
        ...
        public override bool Entry()
        {
            ...
            byte[] CreatorId = Modex360.Functions.Global.convertToBigEndian(BitConverter.GetBytes(this.Package.Header.Metadata.Creator));
        ...
        {
            this.Creator = Modex360.Functions.Global.convertToBigEndian(BitConverter.GetBytes(this.Package.Header.Metadata.Creator));
        ...
        private void BtnClick_LiveryLock(object sender, EventArgs e)
        {
            if (Livery == null)
            {
                Modex360.Functions.UI.messageBox("Please select a livery file before you attempt to unlock one.");
            }
            else
            {
        ...
        private void BtnClick_UnlockAllLiveries(object sender, EventArgs e)
        {
            ...
            if (unlockedCount > 0)
            {
                ...
                Modex360.Functions.UI.messageBox(string.Format("Successfully unlocked {0} liveries!", unlockedCount));
            }
            else
            {
                Modex360.Functions.UI.messageBox("Could not find any locked liveries.");
            }
        }
        ...
        */
        ...
        private void Affinity_MaxAll(object sender, EventArgs e)
        {
            ...
            if (update_count > 0)
            {
                Modex360.Functions.UI.messageBox(string.Format("Updated {0} Affinity levels.", update_count));
            }
            else
            {
                Modex360.Functions.UI.messageBox("All Affinity levels are already 50 or above.", string.Empty, MessageBoxIcon.Information);
            }
        }
        private void Affinity_AddAll(object sender, EventArgs e)
        {
            ...
            {
                Modex360.Functions.UI.messageBox("No new manufacturers to add!", "", MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void InitGarageData()
        {
            ...
            */
            ...
            this.GarageSchema = Encoding.ASCII.GetString(new WebClient().DownloadData(
                string.Format("{0}/forza4/{1}", Modex360.Server.Config.baseURL, "Garage_Schema.txt")));
        ...
        {
            // Thumbnail Server URL: Modex360.Server.Config.baseURL + "forza4/unicorns/" + fileName
        ...
        private void FinishGarageEdit(List<Forza4Garage.Forza4GarageCar> CarList)
        {
            ...
            foreach (Forza4Garage.Forza4Car car in NewCars)
            {
                ...
                {
                    _carThumbs.Add(car.CarId, new WebClient().DownloadData(string.Format("{0}/forza4/unicorns/{1}", Modex360.Server.Config.baseURL, this.CarThumbUrls[car.CarId])));
                }
