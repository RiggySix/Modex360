...
namespace Forza4
{
    public class Forza4Profile
    {
        ...
        public Forza4Profile(EndianIO IO, ulong ProfileId, byte[] baseAesKey, byte[] baseShaKey)
        {
            ...
            this.Creator = Modex360.Functions.Global.convertToBigEndian(BitConverter.GetBytes(ProfileId));
        ...
        private void Read()
        {
            ...
            if (!Modex360.Functions.Global.compareArray(StoredHash, Forza4KeyMarshal.HashData(this.ShaSalt, SaveData, DataEx)))
            {
    ...
    public class Forza4Screenshot
    {
        ...
        public Forza4Screenshot(EndianIO IO, ulong CreatorId, Forza4KeyMarshal Marshal)
        {
            ...
            Creator = Modex360.Functions.Global.convertToBigEndian(BitConverter.GetBytes(CreatorId));
        ...
        public byte[] Read()
        {
            ...
            if (!Modex360.Functions.Global.compareArray(StoredHash, Forza4Security.HashData(this.ShaKey, SaveData, DataEx)))
            {
