...
namespace DeadSpace
{
    public class DeadSpace3Save
    {
        ...
        public void Save()
        {
            ...
            {
                writer.Out.Write(Modex360.Functions.Global.hexStringToArray(inventoryItem.Guid.ToString().Replace("-", "")));
            ...
            //Manager.InjectBlock(0xF7AEC8A0, new Guid(new byte[16]), Modex360.Functions.Global.hexStringToArray(EquippedSuit.ToString().Replace("-", "")));
            */
    ...
    public class SaveBlockManager : List<SaveBlockManager.SaveBlock>
    {
        ...
        public EndianIO Export()
        {
            ...
            foreach (var saveBlock in this)
            {
                ...
                io.Out.Write(Modex360.Functions.Global.hexStringToArray(saveBlock.Guid.ToString().Replace("-", "")));
