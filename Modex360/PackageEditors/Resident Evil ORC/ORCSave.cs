...
namespace ResidentEvil
{
    public class BitStream
    {
        ...
        {
            return BitConverter.ToInt32(Modex360.Functions.Global.convertToBigEndian(Read(0x20, true)), 0);
        }
        public uint ReadUInt32()
        {
            return BitConverter.ToUInt32(Modex360.Functions.Global.convertToBigEndian(Read(0x20, true)), 0);
        }
                        ...
                        for (int i = 0; i < subcount; i++)
                        {
                            ...
                            switch (value_type)
                            {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    float f_tail = BitConverter.ToSingle(Modex360.Functions.Global.convertToBigEndian(PlayerStream.Read(0x20, true)), 0);
                                    break;
                                case 2:
