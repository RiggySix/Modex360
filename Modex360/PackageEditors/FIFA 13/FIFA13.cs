...
{
    public partial class FIFA13 : EditorControl
    {
        //public static readonly string FID = "45410998";
        private FIFA13_GameSave GameSave;
        private FIFA13_GameSave.VirtualProPlayer Player;

        public FIFA13()
        {
            InitializeComponent();
            TitleID = FormID.FIFA13;
            //Set our title ID
            
            // Load Height enumeration
            LoadHeightItems();
        }
        public override bool Entry()
        {
            ...
            GameSave = new FIFA13_GameSave(IO, "Fifa generic error message saving", "my key my key what should it be");
            ...
            var heights = Enum.GetValues(typeof(FIFA13_GameSave.HeightIndex));
            var x = -1;
