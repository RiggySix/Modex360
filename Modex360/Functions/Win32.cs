...
namespace Modex360.Functions
{
    public class Win32
    {
        ...
        // Forces the given window to the foreground even when Windows' normal focus-stealing
        // prevention would otherwise block it (e.g. a window shown from a background/secondary
        // thread, like a form created right after a splash screen on its own thread).
